<div class="ucpf-legal">
	...
	<p class="ucpf-legal__meta"><?php echo esc_html( sprintf( __( 'Last updated: %s', 'universal-consent-privacy-framework' ), $last_updated ) ); ?></p>
	<p><?php echo esc_html( sprintf( __( 'This Cookie Policy explains how %s (“we”) uses cookies and similar technologies on this website.', 'universal-consent-privacy-framework' ), $business_name ) ); ?></p>
