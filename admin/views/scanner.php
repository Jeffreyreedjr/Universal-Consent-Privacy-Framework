	...
	<div class="ucpf-scanner-run" id="ucpf-scanner-run">
		...
		<?php if ( $scanner_ready ) : ?>
			<div class="ucpf-scanner-run__primary">
				...
				<p class="notice notice-warning inline"><strong><?php esc_html_e( 'Scanner API + plugin:', 'universal-consent-privacy-framework' ); ?></strong> <?php esc_html_e( 'Multi-page Playwright scans require Scanner API 1.5.3 or newer (GET /health version and features.exactPaths). Copy tools/ucpf-scanner and restart the Node process — updating this plugin zip does not update the scanner host.', 'universal-consent-privacy-framework' ); ?></p>
				<p>
