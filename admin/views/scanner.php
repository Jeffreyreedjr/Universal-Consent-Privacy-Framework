	...
	<div class="ucpf-scanner-run" id="ucpf-scanner-run">
		...
		<?php if ( $scanner_ready ) : ?>
			<div class="ucpf-scanner-run__primary">
				...
				<p class="notice notice-warning inline"><strong><?php esc_html_e( 'Scanner API + plugin:', 'universal-consent-privacy-framework' ); ?></strong> <?php esc_html_e( 'Multi-page Playwright scans require Scanner API 1.5.1 or newer (GET /health version) that honors exactPaths. Updating this plugin zip does not update the scanner host — redeploy tools/ucpf-scanner.', 'universal-consent-privacy-framework' ); ?></p>
				<p>
