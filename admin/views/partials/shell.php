...
<div class="wrap ucpf-admin">
	<div class="ucpf-shell">
		<nav class="ucpf-shell__nav" aria-label="<?php echo esc_attr( $product ); ?>">
			<p class="ucpf-shell__brand">
				<img
					class="ucpf-shell__brand-mark"
					src="<?php echo esc_url( UCPF_PLUGIN_URL . 'assets/branding/icon-128x128.png' ); ?>"
					alt=""
					width="28"
					height="28"
					decoding="async"
				/>
				<span class="ucpf-shell__brand-text"><?php echo esc_html( $product ); ?></span>
			</p>
