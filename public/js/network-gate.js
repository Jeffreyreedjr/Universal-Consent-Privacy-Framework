...
(function () {
  ...
  function classifyUrl(url) {
    ...
    // Functional: remote fonts, maps / map tiles, media embeds, scheduling, icon kits,
    // and checkout payment widgets (PayPal / Stripe / Square) until Embeds & Widgets consent.
    if (
