	...
	public static function all() {
		return array(
			'google_analytics_4' => array(
				...
				'help'            => __( 'From GA4 Admin → Data streams. Example: G-ABC123XYZ.', 'universal-consent-privacy-framework' ),
				'tag_id_label'    => __( 'Google Tag ID', 'universal-consent-privacy-framework' ),
				'tag_placeholder' => 'GT-XXXXXXXX',
				'tag_help'        => __( 'Optional Google Tag ID (GT-…) from Google Tag / Site Kit. Loaded together with the Measurement ID.', 'universal-consent-privacy-framework' ),
				'category'        => 'analytics',
			),
			'google_tag_manager' => array(
				...
				'help'        => __( 'From GTM container settings. Example: GTM-ABC123.', 'universal-consent-privacy-framework' ),
				'category'    => 'analytics',
			),
			'meta_pixel'         => array(
				...
				'help'        => __( 'Numeric Pixel ID from Meta Events Manager.', 'universal-consent-privacy-framework' ),
				'category'    => 'marketing',
			),
			'microsoft_clarity'  => array(
				...
				'help'        => __( 'Clarity project ID from clarity.microsoft.com.', 'universal-consent-privacy-framework' ),
				'category'    => 'analytics',
			),
			'hotjar'             => array(
				...
				'placeholder' => '1234567',
				'help'        => __( 'Hotjar Site ID (numbers only).', 'universal-consent-privacy-framework' ),
				'category'    => 'analytics',
			),
			'tiktok_pixel'       => array(
				...
				'help'        => __( 'TikTok Ads Manager pixel ID.', 'universal-consent-privacy-framework' ),
				'category'    => 'marketing',
			),
			'linkedin_insight'   => array(
				...
				'placeholder' => '123456',
				'help'        => __( 'LinkedIn Insight Tag partner ID.', 'universal-consent-privacy-framework' ),
				'category'    => 'marketing',
			),
		);
	}
